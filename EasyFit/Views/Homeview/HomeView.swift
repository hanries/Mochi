            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        // Meal sections — disabled: MealSectionView was removed in the
                        // dark-theme redesign. This view is an unreferenced experiment
                        // kept for reference until the Mochi home (Phase 2) replaces it.
